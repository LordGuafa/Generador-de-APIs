...
app.get("/Clientes/*",clientes.getAll);
app.get("/Clientes/:cod_cliente",clientes.getAll);
...
app.get("/Prestamos/*",prestamos.getAll);
app.get("/Prestamos/:id_prestamo",prestamos.getAll);
...
app.get("/Copias/*",copias.getAll);
app.get("/Copias/:n_copia",copias.getAll);
...
app.get("/Peliculas/*",peliculas.getAll);
app.get("/Peliculas/:id_pelicula",peliculas.getAll);
